...
<#
  ...
  against real git repos under $TestDrive, including a real second `git worktree` - git
  plumbing is not worth mocking when the real thing is this cheap to spin up.
#>
