// documentation/src/components/ReadmeContent/index.tsx
...
- [🚀 Fast Track / Usage Guide](docs/usage)
- [📝 Customization Options](docs/customization)
- [⚙️ Parameters & Settings](docs/parameters)
- [🎯 Build Targets](docs/targets)
- [🐳 Docker Templates](docs/docker-templates)
- [🔄 CI/CD Examples](docs/ci-cd)
- [⚡ Advanced Usage](docs/advanced)
- [🛠️ Development Setup](docs/development)
...
> 📋 For comprehensive project metrics including build health, security scans, community stats, and development activity, visit the [**📊 Project Status Dashboard**](docs/project-status) in our documentation.
